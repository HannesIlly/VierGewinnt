...
public class ServerConnection {
     ...
     * 
     * @param connection
     *            the socket that represents this connection
     * @throws IOException
     *             if there occurs an exception when creating the {@link BufferedReader} or {@link BufferedWriter}
     */
     ...
     * @throws IOException
     *             if the {@link BufferedReader} or {@link BufferedWriter} couldn't be created
     */
    ...
    /**
     * Reads an action from the client. If there is no new action the returned action will be {@code null}.
     * 
     * @return The action, that is received from the client or {@code null} if there is none.
     */
    ...
    /**
     * Writes an action to the client.
     * 
     * @param action
     *            The action that is sent to the client.
     */

...
public class ErrorAction extends Action {
    ...
    /**
     * Decodes this error viergewinnt.util.action and returns the content, which is the viergewinnt.util.action that caused the error.
     * 
     * @param data The viergewinnt.util.action data, that will be decoded.
     * @return The viergewinnt.util.action that caused an error.
     */
    public Action decode(byte[] data) {
        ...
        case error:
        default:
            System.out.println("Fehler beim umwandeln: ungültiger viergewinnt.util.action type. type = " + type.toString());
            break;
        }
        return null;
    }

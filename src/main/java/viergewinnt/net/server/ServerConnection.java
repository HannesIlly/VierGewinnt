...
import viergewinnt.util.action.Action;
import viergewinnt.util.action.ActionInputDecoder;
import viergewinnt.util.action.ActionOutputEncoder;
...
public class ServerConnection {
     ...
     *
     * @param action The action that is sent to the client.
     */
